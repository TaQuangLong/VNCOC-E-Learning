...
3. Read `knowledge-graph/entities.md` for entity definitions, indexes, and relationships
4. Read `knowledge-graph/api-map.md` to check existing endpoints and avoid duplicate route registration
