...
namespace ChurchLearn.Api.Features.Discussions.AdminDeleteDiscussion;

public class AdminDeleteDiscussionHandler(AppDbContext db, ICurrentUser currentUser)
{
